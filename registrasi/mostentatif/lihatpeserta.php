                ...
                <div class="col-xs-12">
                  <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title"><b>MOS MAHASISWA BARU STT-PLN</b> | Data Peserta</h3>
                    </div>
                  <table id="dataTables1" class="table table-hover display" cellspacing="0" width="100%">
                              ...
                              <?php
                                ...
                                $result = mysqli_query($koneksi, "SELECT * FROM  mostentatif_peserta WHERE nim='$nim' ORDER BY id ASC ");
