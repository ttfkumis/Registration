                ...
                <div class="col-xs-12">
                  <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title"><b>MOS MAHASISWA BARU STT-PLN</b> | Form Pendaftaran</h3>
                    </div>
                      ...
                      <div class="box-body">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-8">
                              <input type="text" name="nama" class="form-control" size="50" placeholder="ex : VALENTINO ERLANGGA (HURUF KAPITAL SEMUA)" required>
                            </div>
                          </div>
