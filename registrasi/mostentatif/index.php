<?php
  ...
  if($_SESSION['status']!="login"){
    ...
    $result = mysqli_query($koneksi, "SELECT * FROM mostentatif WHERE nim=$nim");
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-right" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class=""><a href="daftar.php?=<?php echo $_SESSION['nim'];?>"><i class="glyphicon glyphicon-pencil"></i> DAFTAR SERTIFIKASI MOS MAHASISWA BARU</a></li>
            <li class=""><a href="lihatpeserta.php?=<?php echo $_SESSION['nim'];?>"><i class="glyphicon glyphicon-list-alt"></i> LIHAT DATA PESERTA</a></li>
            ...
            <li class="" style="margin:3px;">
              <div class="btn-group">
                <button type="button" class="btn btn-secondary btn-lg dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="glyphicon glyphicon-user">  </i><?php echo "&nbsp;&nbsp;". $_SESSION['nim']; ?>
                </button>
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="editpassword.php?=<?php echo $_SESSION['nim'];?>">&nbsp;&nbsp;&nbsp;&nbsp;<i class="glyphicon glyphicon-edit"></i> &nbsp;&nbsp;UBAH PASSWORD</a><br><br>
          ...
          <div class="col-xs-12">
            <div class="box box-danger">
              <div class="box-header">
                  <h3 class="box-title" align:"center"><b>TATA CARA PENDAFTARAN MOS MAHASISWA BARU STT-PLN</b></h3>
