                ...
                <div class="col-xs-12">
                  <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title"><b>MOS MAHASISWA BARU STT-PLN</b> | Form Ubah Data</h3>
                    </div>
                    ...
                    // Getting id from url
                    $result = mysqli_query($koneksi, "SELECT * FROM mostentatif_peserta WHERE nim=$nim");
                      ...
                      <div class="box-body">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="hidden" name="nim" class="form-control" size="50"  value="<?php echo $nim; ?>" ><?php echo $nim; ?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <select class="form-control" name="jurusan" value="<?php echo $jurusan;?>">
                                <option value="<?php echo $jurusan;?>"><?php echo $jurusan;?></option>
                                <option value="S1 T.INFORMATIKA">S1 T.INFORMATIKA</option>
                                <option value="S1 T.ELEKTRO">S1 T.ELEKTRO</option>
                                <option value="S1 T.SIPIL">S1 T.SIPIL</option>
                                <option value="S1 T.MESIN">S1 T.MESIN</option>
                                <option value="D3 T.ELEKTRO">D3 T.ELEKTRO</option>
                                <option value="D3 T.MESIN">D3 T.MESIN</option>
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <select class="form-control" name="program_sertifikasi">
                                ...
                                <option value="MOSWORD">MICROSOFT OFFICE SPECIALIST (MOS) WORD 2013</option>
                                <option value="MOSEXCEL">MICROSOFT OFFICE SPECIALIST (MOS) EXCEL 2013</option>
                                <option value="MOSPPT">MICROSOFT OFFICE SPECIALIST (MOS) POWERPOINT 2013</option>
                              </select>
                            </div>
                          </div>
