<?php
  ...
  if($_SESSION['status']!="login"){
    ...
    $result = mysqli_query($koneksi, "SELECT * FROM mtaumum_akun WHERE username=$username") or die(mysqli_error());
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-right" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class=""><a href="daftar.php?=<?php echo $_SESSION['username'];?>"><i class="glyphicon glyphicon-pencil"></i> DAFTAR SERTIFIKASI MTA UMUM</a></li>
          ...
          <div class="col-xs-12">
            <div class="box box-danger">
              <div class="box-header">
                  <h3 class="box-title" align:"center"><b>TATA CARA PENDAFTARAN MTA UNTUK UMUM</b></h3>
