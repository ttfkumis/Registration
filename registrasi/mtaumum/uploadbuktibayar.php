                ...
                <div class="col-xs-12">
                  <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title"><b>MTA UNTUK UMUM</b> | Form Upload Bukti Pembayaran</h3>
                    </div>
                    ...
                    ?>
                      ...
                      <div class="box-body">
                        ...
                        <script type="text/javascript">
                            function berhasiluploadbuktibayar() {
                               alert("Berhasil Upload Bukti Bayar");
                            }
                        </script>

                        <form onsubmit="berhasiluploadbuktibayar()" action="prosesuploadbuktibayar.php" method="post" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <label class="label-control col-md-3">Upload Bukti Bayar</label>
                            <div class="col-md-8">
                        ...
                        <div class="row col-md-12">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-4">
                              <button type="Submit" name="uploadbuktibayar" class="btn btn-success">
                                <span class="fa fa-plus"></span> Upload Bukti Bayar</button>
