                ...
                <div class="col-xs-12">
                  <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title"><b>MTA UNTUK UMUM</b> | Data Bukti Pembayaran</h3>
                    </div>
                  <table id="dataTables1" class="table table-hover display" cellspacing="0" width="100%">
                              ...
                              <?php
                                ...
                                $result = mysqli_query($koneksi, "SELECT * FROM  mtaumum_peserta WHERE username='$username' ORDER BY id ASC ");
