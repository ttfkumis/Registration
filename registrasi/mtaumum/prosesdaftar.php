...
if (isset($_POST['tambah'])) {
  ...
  //                   VALUES (NULL, NULL, '$nama', NULL, '$jurusan', '$jenis_kelamin', '$ttl', '$alamat', '$hp', '$id_line', '$email', '$program_sertifikasi') WHERE id" or die(mysqli_error($koneksi)) ;
        ...
        $daftar = mysqli_query($koneksi, "INSERT INTO mtaumum_peserta (username,nik,nama,instansi,jenis_kelamin,ttl,alamat,hp,id_line,email,program_sertifikasi) VALUES('$username', '$nik','$nama','$instansi','$jenis_kelamin','$ttl','$alamat','$hp','$id_line','$email','$program_sertifikasi')");
        if($daftar) {
